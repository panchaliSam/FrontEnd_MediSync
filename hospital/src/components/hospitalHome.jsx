...
import {
  ...
  UserIcon,              // User icon for Doctors
} from "@heroicons/react/24/solid";

// Named export for HospitalHome
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen space-y-4 p-4">
      ...
      <div className="flex flex-col items-center justify-center space-y-4 md:flex-row md:space-x-4 md:space-y-0">
        ...
        <Link to="/dashboard/home/appointments" className="w-full max-w-xs">
          <Card className="h-60 w-64 bg-blue-500 text-white hover:bg-blue-600 cursor-pointer">
        ...
        <Link to="/dashboard/home/patient-history" className="w-full max-w-xs">
          <Card className="h-60 w-64 bg-blue-500 text-white hover:bg-blue-600 cursor-pointer">
            <CardBody className="flex flex-col items-center justify-center h-full p-6">
        ...
        {/* Card for Doctors */}
        <Link to="/dashboard/home/doctors" className="w-full max-w-xs">
          <Card className="h-60 w-64 bg-blue-500 text-white hover:bg-blue-600 cursor-pointer">
            <CardBody className="flex flex-col items-center justify-center h-full p-6">
